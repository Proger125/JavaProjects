    ...
    <div class="wrapper">
        <div class="container">
            <form action="<c:url value="process.jsp"/>" method="post">
                ...
                <formBlock:formBlockTag name="city" type="text" valueName="">
                    City
                </formBlock:formBlockTag>
                <formBlock:formBlockTag name="street" type="text" valueName="">
                    Street
                </formBlock:formBlockTag>
                <formBlock:formBlockTag name="house-number" type="text" valueName="">
                    House number
                </formBlock:formBlockTag>
